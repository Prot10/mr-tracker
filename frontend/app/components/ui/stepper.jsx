          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            ...
            >
              ...
              <button
                ...
                className="duration-350 flex items-center justify-center rounded-full bg-indigo-700 py-1.5 px-3.5 font-medium tracking-tight text-white transition hover:bg-indigo-600 active:bg-indigo-500"
                {...nextButtonProps}
              >
